...
qa_gate = Agent(
    role="QA Gate",
    goal="Проверить, что код Разработчика проходит тесты Test Designer'а. "
         "ОБЯЗАТЕЛЬНО запусти тесты через инструмент run_tests — "
         "если падают, это No-Go. Ты — последний рубеж перед production.",
