...
def make_phase_a_tasks(task_description: str) -> list[Task]:
    ...
    review_task = Task(
        ...
        1. Вызови инструмент run_tests БЕЗ АРГУМЕНТОВ — каталог прогона
           он определяет сам. Не передавай пути: любой переданный путь игнорируется.
        ...
        4. НИКОГДА не пиши «тесты невозможно запустить», пока не вызвал
           run_tests и не привёл его дословный вывод в отчёте.
